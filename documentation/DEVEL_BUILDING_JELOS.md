...
Build roots for each device and that device's architecture(s).  For ARM devices JELOS builds it uses a 32bit root for several of the cores used in the 64bit distribution.
